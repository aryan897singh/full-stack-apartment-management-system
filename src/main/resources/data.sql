...
INSERT INTO tenants_tbl (name, email, phone_number, address, father_name, apartment_id, flat_number, aadhar_card_number, criminal_history, agreement_signed, join_date, exists_flag) VALUES
                                                                                                                                                                                         ('Aryan Singh', 'arjun.sharma@email.com', '9876543210', '123 MG Road, Mumbai', 'Rajesh Sharma', (SELECT id FROM apartment_tbl WHERE flat_number = '101'), '101', '123456789012', FALSE, TRUE, NOW(), TRUE),
                                                                                                                                                                                         ('Yashpal Singh', 'priya.patel@email.com', '9876543211', '456 Park Street, Delhi', 'Suresh Patel', (SELECT id FROM apartment_tbl WHERE flat_number = '102'), '102', '234567890123', FALSE, TRUE, NOW(), TRUE),
                                                                                                                                                                                         ('Aradhya Singh', 'rohit.kumar@email.com', '9876543212', '789 Brigade Road, Bangalore', 'Mahesh Kumar', (SELECT id FROM apartment_tbl WHERE flat_number = '103'), '103', '345678901234', FALSE, FALSE, NOW(), TRUE),
                                                                                                                                                                                         ('Anamika Singh', 'sneha.gupta@email.com', '9876543213', '321 Commercial Street, Chennai', 'Ramesh Gupta', (SELECT id FROM apartment_tbl WHERE flat_number = '104'), '104', '456789012345', FALSE, TRUE, NOW(), TRUE),
                                                                                                                                                                                         ('Manvendra Singh', 'vikram.singh@email.com', '9876543214', '654 Connaught Place, Delhi', 'Harpreet Singh', (SELECT id FROM apartment_tbl WHERE flat_number = '105'), '105', '567890123456', FALSE, TRUE, NOW(), TRUE),
                                                                                                                                                                                         ('Anita Reddy', 'anita.reddy@email.com', '9876543215', '987 Jubilee Hills, Hyderabad', 'Venkat Reddy', (SELECT id FROM apartment_tbl WHERE flat_number = '201'), '201', '678901234567', FALSE, TRUE, NOW(), TRUE);
